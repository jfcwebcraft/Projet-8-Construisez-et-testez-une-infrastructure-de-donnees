...
Ressources provisionnées :
  ...
  - SNS Topic + abonnement email pour les alertes CloudWatch
...
# -----------------------------------------------------------------------
# SNS Topic pour les alertes CloudWatch (alarmes RDS + DBT)
# -----------------------------------------------------------------------
...
# Abonnement email — l'adresse doit confirmer via le lien reçu par mail
...
# -----------------------------------------------------------------------
# RDS PostgreSQL 16 (db.t3.micro, 20 Go)
# -----------------------------------------------------------------------
...
resource "aws_cloudwatch_metric_alarm" "rds_high_cpu" {
  ...
  # Notification vers le topic SNS (email)
